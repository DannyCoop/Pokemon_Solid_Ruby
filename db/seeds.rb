squirtle = Pokemon.create(name: "Squirtle", hp: 101)
charmander = Pokemon.create(name: "Charmander", hp: 99)
...
tp1 = TrainerPokemon.create(trainer_id: ian_mac.id, pokemon_id: squirtle.id, nickname: "nickname")
tp2 = TrainerPokemon.create(trainer_id: danny_coop.id, pokemon_id: charmander.id, nickname: "notname")
